...
project=digitelMpc_${version}
module=digitelMpc
launch_opi=/${project}/${module}/$opifile

# links="${SCRIPT_DIR}=${project}/${module},\
links="/dls_sw/work/R3.14.12.3/support/digitelMpc/digitelMpcApp/opi/opi=${project}/digitelMpc,\
/dls_sw/prod/R3.14.12.3/support/calc/3-1/calcApp/opi/opi=/${project}/calc"
